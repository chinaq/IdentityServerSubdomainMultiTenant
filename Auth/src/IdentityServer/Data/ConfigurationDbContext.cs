    ...
    public class ConfigurationDbContext : IdentityServer4.EntityFramework.DbContexts.ConfigurationDbContext<ConfigurationDbContext>
    {
        ...
        private void ClientSeed(ModelBuilder builder)
        {
            ...
            builder.Entity<ClientPostLogoutRedirectUri>()
                ...
                {
                    Id = 2,
                    PostLogoutRedirectUri = "http://tenant1.lalita.com:4200",
                    ClientId = 4
                },
                new ClientPostLogoutRedirectUri
                {
                    Id = 3,
                    PostLogoutRedirectUri = "http://tenant2.lalita.com:4200",
                    ClientId = 4
                });
            ...
            builder.Entity<ClientRedirectUri>()
                ...
                {
                    Id = 2,
                    RedirectUri = "http://tenant1.lalita.com:4200/callback.html",
                    ClientId = 4
                },
                new ClientRedirectUri
                {
                    Id = 3,
                    RedirectUri = "http://tenant2.lalita.com:4200/callback.html",
                    ClientId = 4
                },
                new ClientRedirectUri
                {
                    Id = 4,
                    RedirectUri = "http://tenant1.lalita.com:4200",
                    ClientId = 4
                },
                 new ClientRedirectUri
                 {
                     Id = 5,
                     RedirectUri = "http://tenant2.lalita.com:4200",
                     ClientId = 4
                 }, 
                  new ClientRedirectUri
                  {
                      Id = 6,
                      RedirectUri = "http://tenant1.lalita.com:4200/silent-renew.html",
                      ClientId = 4
                  },
                   new ClientRedirectUri
                   {
                       Id = 7,
                       RedirectUri = "http://tenant2.lalita.com:4200/silent-renew.html",
                       ClientId = 4
                   });
            ...
            builder.Entity<ClientCorsOrigin>()
                ...
                {
                    Id = 1,
                    Origin = "http://tenant1.lalita.com:4200",
                    ClientId = 4
                },
                new ClientCorsOrigin
                {
                    Id = 2,
                    Origin = "http://tenant2.lalita.com:4200",
                    ClientId = 4
                });
        }
    }
